    ...
    for key, entry in projects.items():
        ...
        if isinstance(root_team_dir, Path):
            ...
            latest_planning_handoff_summary = action_audit.summarize_planning_handoff_snapshot(
                latest_replan_auto_routing_policy.get("planning_handoff")
            )
        ...
        worker_apply_ready = _worker_apply_ready(task)
        ...
        return TaskDetailDTO(
            ...
            background_run_task_contract_module_summary=_worker_module_summary(task),
            background_run_task_contract_policy_summary=_worker_policy_summary(task),
            background_run_worker_gate_summary=_worker_gate_summary(task),
            background_run_worker_profile_summary=_worker_profile_summary(task),
            background_run_worker_checklist_summary=_worker_checklist_summary(task),
            background_run_worker_items_summary=_worker_items_summary(task),
            ...
            background_run_worker_record_set_summary=_worker_record_set_summary(task),
            background_run_worker_record_set=_worker_record_set(task),
            ...
            background_run_canonical_mutation_summary=_canonical_mutation_summary(task),
