...
def help_text(
    ...
    *,
    ...
    text = (
        ...
        "- aoe orch bgw-ping [--orch <name>]   # test_only bounded worker ping\n"
        "- aoe orch bgw-task [--orch <name>]   # test_only task-scoped worker invoke\n"
        ...
        "- aoe orch bgx-result [--orch <name>]\n"
        "- aoe orch bgx-emit-ack [--orch <name>]   # test_only external pickup harness\n"
        "- aoe orch bgx-emit-result [--orch <name>] [completed|failed]   # test_only external result harness\n"
