...
def normalize_background_run_ticket_snapshot(raw: Any) -> Dict[str, Any]:
    ...
    for key, limit in (
        ...
        ("worker_gate_status", 64),
        ("worker_gate_summary", 240),
        ("worker_profile_status", 64),
        ("worker_profile_summary", 240),
    ...
    for key, limit in (
        ...
        ("worker_records", 8),
        ("worker_record_rows", 8),
        ("worker_preflight_rows", 8),
...
def build_local_background_provider_task_launch_spec(
    *,
    ...
    contract_module = _trim(task_contract_module, 48)
    if contract_module:
        payload["provider_task_contract_module"] = contract_module
    ...
    return deepcopy(
        {
            ...
            "background_run_worker_gate_status": snapshot.get("worker_gate_status", ""),
            "background_run_worker_gate_summary": snapshot.get("worker_gate_summary", ""),
            "background_run_worker_profile_status": snapshot.get("worker_profile_status", ""),
            "background_run_worker_profile_summary": snapshot.get("worker_profile_summary", ""),
            "background_run_worker_checklist_status": snapshot.get("worker_checklist_status", ""),
            ...
            "background_run_worker_records_summary": snapshot.get("worker_records_summary", ""),
            ...
            "background_run_worker_preflight_rows": list(snapshot.get("worker_preflight_rows") or []),
            ...
            "background_run_worker_update_stub_status": snapshot.get("worker_update_stub_status", ""),
            "background_run_worker_update_stub_summary": snapshot.get("worker_update_stub_summary", ""),
            "background_run_worker_update_stub_targets": list(snapshot.get("worker_update_stub_targets") or []),
