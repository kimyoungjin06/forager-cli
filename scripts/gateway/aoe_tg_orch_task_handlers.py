    ...
    *,
    ...
    if cmd in {"status", "orch-status"}:
        ...
        send(
            ...
            f"{runner_line}{runner_note_line}{run_lock_line}{run_lock_note_line}{workspace_line}{document_registry_line}{model_routing_line}{model_registry_line}{judge_binding_line}{judge_probe_line}{judge_bridge_line}{replan_auto_routing_policy_line}{replan_auto_route_status_line}{manual_step_line}{canonical_writeback_line}{canonical_mutation_line}{worker_module_line}{worker_policy_line}{worker_gate_line}{worker_profile_line}{worker_apply_accept_line}{worker_syncback_line}{escalation_binding_line}{escalation_probe_line}{slots_line}{queue_line}{scheduler_line}{worker_line}{external_line}{external_next_line}\n{status}",
            context="status",
            with_menu=False,
            reply_markup=_orch_status_reply_markup(manager_state, key, entry),
        )
